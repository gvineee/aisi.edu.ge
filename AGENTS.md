# Codex — აისის ახალი საიტისა და სკოლის პლატფორმის განხორციელება

## უახლესი დავალება — 2026-09-11

ჯერ წაიკითხე `Codex-PLATFORM-MODULES.md`: მასში აღწერილია `design/app/platform/`-ში აწყობილი 12 ახალი ეკრანის Laravel-ში გადატანის სრული ტექნიკური კონტრაქტი, მონაცემთა მოდელები, უფლებები, პროცესები, ტესტები და ფაზები. შემდეგ გამოიყენე `Codex-FINISH-MIGRATION.md` და `START-HERE-AGENTS.md` დარჩენილი საჯარო საიტისა და კონტენტის სამუშაოებისთვის. უახლესი დავალება ცვლის ძველ, მასთან წინააღმდეგობრივ სტატუსსა და ლოგოს მითითებას.

## განახლებული სრული განხორციელების დავალება

მომხმარებლის ბოლო სრული დავალებაა `START-HERE-AGENTS.md`. რეალური განხორციელების გაგრძელებისას ჯერ წაიკითხე ის: მოიცავს არსებულ Laravel პროექტზე გაგრძელებას, ბოლო BPG/რებრენდინგის გადაწყვეტილებებს, ყველა ფუნქციური ეტაპის სამუშაოს და მიღების კრიტერიუმებს. მისი კონკრეტული მოთხოვნები აზუსტებს ამ ფაილის ძველ ზოგად ფაზა-1-ის შეზღუდვას; უსაფრთხოების და მონაცემთა იზოლაციის ქვემოთ მოცემული წესები ძალაში რჩება.
...
## აუდიტისა და საბოლოო დიზაინის დანართი

- არსებული ჟურნალი: https://aisi.edupage.org/ . პორტალის ფაზამდე დააფიქსირე retain/integrate/replace გადაწყვეტილება; API/SSO ხელმისაწვდომობა არ ივარაუდო. საჯარო საიტიდან მოქმედი ჟურნალის ბმული შეინარჩუნე გარდამავალ პერიოდში.
- არსებული კატალოგი: https://aisi.edu.ge/online-library/ . გადაიტანე უფლებაშემოწმებული მეტამონაცემები/ბმულები; ფაილები მხოლოდ გავრცელების უფლების შემდეგ. სრული მიგრაციის მოთხოვნა ნახე სპეციფიკაციის ბოლო დანართში.
- დიზაინის პრაქტიკული რუკა: `docs/04-design-handoff.md`. პროტოტიპი მდებარეობს `design/app/AisiConcept.tsx` და `design/app/globals.css`; ეს React-ის ვიზუალური მითითებაა. Laravel-ში გადაიტანე React კომპონენტები/ტოკენები და არა Vinext/Cloudflare runtime. პროტოტიპის როლების გადამრთველი მხოლოდ პრეზენტაციისთვისაა; production-ში როლი განისაზღვროს server-side membership/policy-დან.

...
**Production deploy — 2026-09-15**: `admin:reset-password`-ის კოდი (ახალი ფაილი, migration/route/frontend ცვლილება არ სჭირდება) რეალურად დეპლოირებულია იმავე დადგენილი ნიმუშით — დეტალები ცალკე commit-ში ქვემოთ.
